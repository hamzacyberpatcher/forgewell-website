...
const AboutUs = () => {
  return (
    <div className="w-full flex flex-col-reverse lg:flex-row bg-brand-primary overflow-hidden py-6 sm:py-8 lg:py-0 h-[calc(100vh-5rem)]">
      ...
      <div className="w-full lg:w-1/2 px-5 sm:px-8 lg:px-12 xl:px-16 flex items-center py-4 lg:py-10">
        <div className="w-full max-w-xl space-y-3 sm:space-y-4">
          ...
          <h1 className="text-white text-3xl sm:text-4xl md:text-5xl xl:text-6xl leading-tight font-semibold">We've kept on delivering</h1>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-5 sm:px-8 lg:px-0 pt-4 lg:pt-0">
        <div className="relative w-[60%] sm:w-[50%] md:w-[45%] lg:w-[65%] xl:w-[55%] aspect-[3/4]">
          <Image src="/deckel.png" alt="Forgewell machinery" fill priority className="object-contain"
